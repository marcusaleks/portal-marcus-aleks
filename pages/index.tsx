  ...
  return (
    <div className="min-h-screen bg-[#05070a] text-slate-300 font-sans selection:bg-blue-500/30 font-bold" style={{ fontSize: '1.2em' }}>
      ...
      <nav className="max-w-7xl mx-auto px-6 py-10 flex justify-between items-center">
        <div className="flex items-center gap-3"><div className="bg-blue-600 px-3 py-1 rounded font-black text-white text-[16px]">MAD</div><span className="text-[1.2em] font-black tracking-widest text-blue-500 uppercase">MARCUS ALEKS</span></div>
