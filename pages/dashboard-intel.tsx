...
export default function SifazDashboard() {
  ...
  // 1. DICIONÁRIO INTEGRAL DE DORKS (18 ITENS)
  const dorkLibrary = [
  ...
  // 2. REPOSITÓRIO INTEGRAL DE LEGISLAÇÃO (11 ITENS)
  const legislationList = [
    ...
    { title: 'Lei 9.613/98 (Lavagem)', desc: 'Crimes de Lavagem de Bens e COAF', url: 'https://www.planalto.gov.br/ccivil_03/leis/l9613.htm' },
    { title: 'Prot. CONFAZ 66/2009', desc: 'Sistemas de Inteligência Fazendária', url: 'https://www.confaz.fazenda.gov.br/legislacao/protocolos/2009/pt066_09' },
    { title: 'LC 105/2001', desc: 'Sigilo Bancário e Acesso do Fisco', url: 'https://www.planalto.gov.br/ccivil_03/leis/lcp/lcp105.htm' },
    { title: 'Lei 12.527/11 (LAI)', desc: 'Lei de Acesso à Informação e Transparência', url: 'https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2011/lei/l12527.htm' },
    { title: 'LGPD Lei 13.709/18', desc: 'Privacidade e Bases Legais de Dados', url: 'https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm' },
  ...
  return (
    <div className="min-h-screen bg-[#020408] text-slate-400 font-sans">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
               ...
               <div className="lg:col-span-2 space-y-6">
                  ...
                  <div className="grid gap-4">
                     {intelNews.map((news: any, idx: number) => (
                        <div key={idx} className="p-6 bg-slate-900/20 border border-slate-800 rounded-xl hover:border-blue-900/40 transition-all font-bold group">
                           ...
                           <a href={news.link} target="_blank" className="inline-flex items-center gap-1 text-blue-500 text-[9px] font-black uppercase mt-4 hover:underline">
        ...
        {/* ABA OSINT: DICIONÁRIO COMPLETO + PHOTO ID */}
        {activeTab === 'osint' && (
          <div className="space-y-10 animate-in fade-in duration-500">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {dorkLibrary.map((d) => (
                <div key={d.id} className="bg-slate-900/40 border border-slate-800 p-5 rounded-xl hover:border-slate-700 transition-all font-bold group">
                  ...
                  <div className="bg-black/60 p-3 rounded border border-slate-800 font-mono text-[10px] text-blue-400 relative group-hover:border-blue-500/30">
                    ...
                    <button onClick={() => copyToClipboard(d.code, d.id)} className="absolute top-2 right-2 text-slate-600 hover:text-white transition-colors">
                      {copiedId === d.id ? <Check size={14} className="text-emerald-500" /> : <Copy size={14} />}
                    </button>
                  </div>
                </div>
              ))}
        ...
        {/* ABA LEGISLAÇÃO: REPOSITÓRIO COMPLETO */}
               ...
               <table className="w-full text-left text-xs">
                  ...
                  <tbody className="divide-y divide-slate-800">
                     {legislationList.map((l, i) => (
                        <tr key={i} className="hover:bg-blue-600/5 transition-all font-bold group">
